...
//   return (
//     <div>
//     A heathcare application for people of all color!
//     {/*  <Welcome
//         loopDuration={1100}
//         data={[
//         {
//        image: require('./flags.png'),
//    text: 'ColorCar',
...
const useStyles = makeStyles((theme) => ({
  ...
  image: {
    backgroundImage:
      "url(https://production-tcf.imgix.net/app/uploads/2019/12/18171821/taylor_header-01.png?auto=format%2Ccompress&q=80&fit=crop&w=1200&h=600)",
